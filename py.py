...
async def on_message(message):
    ...
    if message.content.startswith("!패치노트"):
        ...
        await message.channel.send(embed=embed)
        embed = discord.Embed(title=" *0.1.1 ", description=" 2019년 07월 05일 금요일, 이제 배돌이가 무작위로 시 한편을 읊어줍니다", color=0x00fefe)
        await message.channel.send(embed=embed)
    ...
    if message.content.startswith('!오늘뭐할까'):
     ...
     if message.content.startswith("!오늘의시한편"):
        ...
        if randomNum==2:
            await message.channel.send(embed=discord.Embed(title="바다", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="윤동주 시인", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="===========", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="실어다 뿌리는 ", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="바람조차 시원타.", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="===========", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="솔나무 가지마다 새촘히 ", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="고개를 돌리어 뻐들어지고,", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="===========", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="밀치고 ", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="밀치운다.", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="===========", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="이랑을 넘은 물결은 ", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="폭포처럼 피어오른다.", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="===========", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="해변에 아이들이 모인다", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="찰찰 손을 씻고 구보로,", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="바다는 자꾸 설워진다.", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="갈매기의 노래에 .....", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="===========", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="돌아다보고 돌아다보고", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="돌아가는 오늘의 바다여!", color=0xfefefe))
        if randomNum==3:
        ...
        if randomNum==4:
            await message.channel.send(embed=discord.Embed(title="하늘 냄새", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="박희순 시인", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="===========", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="사람이", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="하늘처럼", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="맑아 보일 때가 있다.", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="===========", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="그때 나는 ", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="그 사람에게서", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="하늘 냄새를 맡는다.", color=0xfefefe))
        if randomNum==5:
            await message.channel.send(embed=discord.Embed(title="호수", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="정지용 시인", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="===========", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="얼굴 하나야", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="손바닥 둘로 ", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="푹 가리지만", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="===========", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="보고 싶은 마음 ", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="호수만 하니", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="눈 감을 수 밖에", color=0xfefefe))
         if randomNum==6:
         ...
         if randomNum==9:
            await message.channel.send(embed=discord.Embed(title="너 외롭구나", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="김형태 시인", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="===========", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="깊이 ", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="=========== ", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="앓으십시요", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="앓음답도록 ", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="아름답도록", color=0xfefefe))
        if randomNum==10:
            await message.channel.send(embed=discord.Embed(title="가을", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="한민복 시인", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="===========", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="그대 생각을  ", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="켜 놓은 채 ", color=0xfefefe))
            await message.channel.send(embed=discord.Embed(title="잠이 들었습니다", color=0xfefefe))
